...
const SHOP_ITEMS = [
  { id: "cannon_speed", title: "تطوير سرعة المدفع", desc: "يقلل من وقت إعادة الإطلاق ويزيد من سرعة إطلاق الجنود.", price: [40, 80, 150, 250, 400], max: 5 },
  { id: "army_start", title: "زيادة الجنود عند البداية", desc: "تبدأ بعدد أكبر من الجنود في كل مرحلة.", price: [50, 90, 180, 320, 550], max: 5 },
  { id: "soldier_power", title: "تقوية الجنود", desc: "يصبح كل جندي أقوى ويحتاج العدو لعدد أكبر لهزيمته.", price: [60, 130, 220], max: 3 },
  { id: "coin_boost", title: "مضاعفة العملات", desc: "تحصل على عملات أكثر عند الفوز (x1.5).", price: [120], max: 1 },
  { id: "shield", title: "درع حماية (مرحلة واحدة)", desc: "يحمي جيشك من أول بوابة سالبة في المرحلة القادمة.", price: [70], max: 1 }
];
function getPlayerData() { return JSON.parse(localStorage.getItem("ldbaba_save") || "{}"); }
function setPlayerData(data) { localStorage.setItem("ldbaba_save", JSON.stringify(data)); }
function getDefaultData() { return { coins: 0, upgrades: { cannon_speed: 0, army_start: 0, soldier_power: 0, coin_boost: 0, shield: 0 }, lastLevel: 1 }; }
